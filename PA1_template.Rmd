...
```{r data_summed_by_date, include=TRUE}
knitr::opts_chunk$set(echo = TRUE)
...
```{r data_average_per_interval, include=TRUE}
knitr::opts_chunk$set(echo = TRUE)
...
```{r imputed_missing_values, include=TRUE}
knitr::opts_chunk$set(echo = TRUE)
...
```{r average_interval_per_daytype, include=TRUE}
knitr::opts_chunk$set(echo = TRUE)
